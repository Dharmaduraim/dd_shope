  ...
  <div class="user_options-container">
    <div class="user_options-text">
      ...
      <div class="user_options-registered">
        ...
        <button class="user_registered-login" id="login-button"><a style="color: white"  href="<?=base_url("login");?>">Login</a></button>
      </div>
    </div>
    ...
    <div class="user_options-forms" id="user_options-forms">
      ...
      <div class="user_forms-signup">
        <h4><a class="nav-link " href="<?=base_url('');?>"  
                    aria-haspopup="true" aria-expanded="false">Home</a></h4>
        <h2 class="forms_title">Sign Up</h2>
        <?php echo validation_errors();?>
        <form method='post' action='<?=base_url('login/register');?>' class="forms_form">
...
document.addEventListener("DOMContentLoaded", function() {
    let formDiv = document.getElementById("user_options-forms");
    formDiv.classList.add("bounceLeft");
