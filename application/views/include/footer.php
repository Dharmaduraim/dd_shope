<footer id="footer" class="mt-5">
        ...
        <div class="col-md-3 col-sm-6">
          <div class="footer-menu footer-menu-001">
            <div class="footer-intro mb-4">
              <a href="index.html">
                <img src="<?=base_url('asset/images/main-logo.png');?>" alt="logo">
              </a>
            </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6 text-end">
            <p>© Copyright 2025 DDSHOP. All rights reserved. Design by</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <script src="<?=base_url('asset/https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha3/dist/js/bootstrap.bundle.min.js');?>"
    integrity="sha384-ENjdO4Dr2bkBIFxQpeoTz1HIcje39Wm4jDKdf19U8gI4ddQ3GYNS7NTKfAdVQSZe"
    crossorigin="anonymous"></script>
  <script src="<?=base_url('asset/https://cdn.jsdelivr.net/npm/swiper@9/swiper-bundle.min.js');?>"></script>
  <script src="<?=base_url('asset/js/script.min.js');?>"></script>
