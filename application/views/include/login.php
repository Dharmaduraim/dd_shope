  ...
  <div class="user_options-container">
    <div class="user_options-text">
      <div class="user_options-unregistered">
        ...
        <button class="user_unregistered-signup" id="signup-button"> <a style="color: white"  href="<?=base_url("login/signup");?>">Sign up</a></button>
      </div>
...
<?php endif; ?>
       <?php echo validation_errors(); ?>
        <form method='post' action='<?=base_url('login/login');?>' class="forms_form">
