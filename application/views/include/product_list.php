...
.o-slider-product-tray__slide {
  ...
  width: 200px;              /* fixed width per product */
}
.o-slider-product-tray__inner {
  display: grid;
          ...
          <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
            ...
            <div class="offcanvas-body">
              <ul class="navbar-nav justify-content-end flex-grow-1 gap-1 gap-md-5 pe-3">
                ...
                <li class="nav-item dropdown">
                  <a class="nav-link " href="<?=base_url('user-details');?>"  
                    aria-haspopup="true" aria-expanded="false">User Details</a>
                </li>
                <li class="nav-item dropdown">
                  <a class="nav-link" href="<?=base_url('products');?>" id="dropdownBlog" data-bs-toggle="dropdown"
                    aria-haspopup="true" aria-expanded="false">Product List</a>
                </li>
                <li class="nav-item">
        ...
        <div class="col-3 col-lg-auto">
          <ul class="list-unstyled d-flex m-0">
           <!--  <li class="d-none d-lg-block">
              <a href="<?=base_url('login/signup');?>" class="text-uppercase mx-3">Register <span class="wishlist-count"></span>
              </a>
            </li>
            <li class="d-none d-lg-block">
              <a href="<?=base_url('login');?>" class="text-uppercase mx-3" data-bs-toggle="offcanvas" data-bs-target="#offcanvasCart"
                aria-controls="offcanvasCart">Login <span class="cart-count"></span>
              </a>
            </li> -->
            <!-- <li class="d-lg-none">
              <a href="#" class="mx-2">
...
<h4 style="text-align: center;">Product Details</h4>
  <table id="example" class="display nowrap" cellspacing="0" width="100%">
        ...
        <tbody>
          <?php if (!empty($products)): ?>
            ...
            <tr>
               ...
               <td> <img src="<?php echo base_url('uploads/'.$product->product_image); ?>" 
         alt="<?php echo $product->product_name; ?>" 
         width="150"></td>
                 <td><?php echo $product->product_descryption; ?></td>
   ...
   data-desc="<?php echo $product->product_descryption; ?>"
   data-image="<?php echo base_url('uploads/'.$product->product_image); ?>">
...
<form id="productForm" action="<?php echo site_url('product/product_add'); ?>" method="post" enctype="multipart/form-data">
          ...
          <div class="mb-3">
            <label class="product_category">Category</label>
          ...
          <div class="mb-3">
            ...
            <textarea name="product_descryption" id="product_descryption" class="form-control" rows="3"></textarea>
          </div>

          <button type="submit" class="btn btn-primary Product_btn">Save Product</button>
        </form>
      </div>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form id="productForm" action="<?php echo site_url('product/update'); ?>" method="post" enctype="multipart/form-data">
          <input type="hidden" name="id" id="product_id">
          <div class="mb-3">
            <label class="form-label">Product Name</label>
            <input type="text" id="product_name_value" name="product_name" class="form-control" required>
          </div>

          <div class="mb-3">
            <label class="form-label">Category</label>
            <select id="product_category_value" name="product_category" class="form-select" required>
              <option value="">-- Select Category --</option>
          ...
          <div class="mb-3">
            <label class="form-label">Price</label>
            <input type="number" id="product_price_value" name="product_price" class="form-control" required>
          </div>

          <div class="mb-3">
            <label class="form-label">Image</label>
            <input type="file"  id="product_image_value" src="" name="product_image" class="form-control" >
             <input type="hidden" name="old_image" id="old_image">
            <img id="current_image" src="" class="img-fluid mt-2" style="max-height:100px;">
          </div>

          <div class="mb-3">
            <label class="form-label">Description</label>
            <textarea name="product_descryption" id="product_descryption_value" class="form-control" rows="3" required></textarea>
          </div>
        ...
        <div class="collection-item d-flex flex-wrap my-5">
          <div class="col-md-6 column-container">
            <div class="image-holder">
              <img src="<?=base_url('asset/images/single-image-2.jpg');?>" alt="collection" class="product-image img-fluid">
            </div>
          </div>
...
<script type="text/javascript">
  $(document).ready(function () {
    ...
    if ($("#product_price").val().trim() === "") {
        ...
        $("#product_price").removeClass("is-invalid").addClass("is-valid");
    }
    ...
    if ($("#product_image").val().trim() === "") {
        ...
        $("#product_image").removeClass("is-invalid").addClass("is-valid");
    }

    // Description
    if ($("#product_descryption").val().trim() === "") {
        $("#product_descryption").addClass("is-invalid");
        isValid = false;
    } else {
        $("#product_descryption").removeClass("is-invalid").addClass("is-valid");
    }
    ...
    $.ajax({
        url: "<?php echo site_url('category'); ?>",
        type: "GET",
        success: function (response) {
            $("#product_category").append(response);
        },
        error: function () {
...
$(document).on("click", ".editBtn", function () {
    ...
    // set values
    $("#product_id").val(id);
    $("#product_name_value").val(name);
    $("#product_category_value").val(category);
    $("#product_price_value").val(price);
    $("#product_descryption_value").val(desc);
    $("#current_image").attr("src", image);
    $("#old_image").val(image.split('/').pop());
    // open modal
 ...
 $.ajax({
        ...
        type: "GET",
        success: function (response) {
            $("#product_category_value").append(response);
        },
        error: function () {
            alert("Error loading categories!");
        }
