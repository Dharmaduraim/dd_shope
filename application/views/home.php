          ...
          <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
            ...
            <div class="offcanvas-body">
              <ul class="navbar-nav justify-content-end flex-grow-1 gap-1 gap-md-5 pe-3">
                ...
                <li class="nav-item ">
                  <a class="nav-link" href="" id="dropdownBlog" data-bs-toggle="dropdown"
        ...
        <div class="col-3 col-lg-auto">
          <ul class="list-unstyled d-flex m-0">
            <li class="d-none d-lg-block">
             ...
             <li class="d-none d-lg-block">
              <a href="<?=base_url('login');?>" class="text-uppercase mx-3">Login <span class="wishlist-count"></span>
              </a>
            </li>
           <!--  <li class="d-none d-lg-block">
...
<div class="c-product-tray">
  ...
  <div class="o-wrapper">
    ...
    <h2 class="c-product-tray__heading">Our Products</h2><!-- /c-product-tray__heading -->
 ...
 <?php if (!empty($products)): ?>
          ...
          <li class="o-slider-product-tray__slide">
            ...
            <img class="c-product-tile__image" src="<?php echo base_url('uploads/'.$product->product_image); ?>" 
         alt="<?php echo $product->product_name; ?>" 
         width="150">
            <h3 class="c-product-tile__name"><?php echo $product->product_name; ?></h3>
                <span class="c-product-tile__price"><?php echo $product->product_price; ?></span>
                <br>
                <span class="c-product-tile__price"><?php echo substr($product->product_descryption, 0, 30); ?>
               </span>
               <br>
    <button class="btn btn-info btn-sm viewBtn" 
        ...
        View
    </button> <button class="btn btn-success btn-sm addCartBtn" data-id="<?php echo $product->id; ?>" data-price="<?php echo $product->product_price * 100; ?>"> <!-- price in paise -->
    Add to Cart
</button>
...
var isLoggedIn = <?php echo $this->session->userdata('id') ? 'true' : 'false'; ?>;
$(document).on("click", ".addCartBtn", function () {
    ...
    $.ajax({
        url: "<?php echo site_url('login/add'); ?>",
        type: "POST",
        data: { id: productId },
        dataType: "json",
        success: function (response) {
            if (response.status == "success") {
                ...
                // window.location.href = "<?php echo site_url('login/payment'); ?>";
                alert("Not Include Payment Process");
            } else {
                alert(response.message);
            }
        }
